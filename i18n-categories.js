...
(function () {
  ...
  var P4 = {
    en: ["Kids","Club logos","Kuwaiti logos","One Piece","Naruto"],
    fr: ["Enfants","Logos de clubs","Logos koweïtiens","One Piece","Naruto"],
    es: ["Niños","Escudos de clubes","Logotipos kuwaitíes","One Piece","Naruto"],
    pt: ["Crianças","Emblemas de clubes","Logótipos kuwaitianos","One Piece","Naruto"],
    de: ["Kinder","Vereinswappen","Kuwaitische Logos","One Piece","Naruto"],
    it: ["Bambini","Stemmi dei club","Loghi kuwaitiani","One Piece","Naruto"],
    nl: ["Kinderen","Clublogo's","Koeweitse logo's","One Piece","Naruto"],
    sv: ["Barn","Klubbmärken","Kuwaitiska logotyper","One Piece","Naruto"],
    pl: ["Dzieci","Herby klubów","Kuwejckie logo","One Piece","Naruto"],
    cs: ["Děti","Klubové znaky","Kuvajtská loga","One Piece","Naruto"],
    ro: ["Copii","Embleme de cluburi","Logouri kuweitiene","One Piece","Naruto"],
    hu: ["Gyerekek","Klubcímerek","Kuvaiti logók","One Piece","Naruto"],
    el: ["Παιδιά","Σήματα ομάδων","Λογότυπα του Κουβέιτ","Ουάν Πις","Νάρουτο"],
    ru: ["Детям","Эмблемы клубов","Логотипы Кувейта","Ван-Пис","Наруто"],
    uk: ["Дітям","Емблеми клубів","Логотипи Кувейту","Ван Піс","Наруто"],
    tr: ["Çocuklar","Kulüp logoları","Kuveyt logoları","One Piece","Naruto"],
    az: ["Uşaqlar","Klub loqoları","Küveyt loqoları","One Piece","Naruto"],
    fa: ["کودکان","نشان باشگاه‌ها","لوگوهای کویتی","وان پیس","ناروتو"],
    ku: ["Zarok","Logoyên klûban","Logoyên Kuweytê","One Piece","Naruto"],
    ur: ["بچے","کلبوں کے لوگو","کویتی لوگو","ون پیس","ناروٹو"],
    ps: ["ماشومان","د کلبونو نښې","کویټي نښې","ون پیس","ناروتو"],
    he: ["ילדים","סמלי מועדונים","לוגואים כוויתיים","וואן פיס","נארוטו"],
    hi: ["बच्चे","क्लबों के लोगो","कुवैती लोगो","वन पीस","नारुतो"],
    bn: ["শিশু","ক্লাবের লোগো","কুয়েতি লোগো","ওয়ান পিস","নারুতো"],
    ta: ["குழந்தைகள்","கழக சின்னங்கள்","குவைத் சின்னங்கள்","ஒன் பீஸ்","நருடோ"],
    id: ["Anak-anak","Logo klub","Logo Kuwait","One Piece","Naruto"],
    ms: ["Kanak-kanak","Logo kelab","Logo Kuwait","One Piece","Naruto"],
    zh: ["儿童","俱乐部队徽","科威特标志","海贼王","火影忍者"],
    ja: ["キッズ","クラブのエンブレム","クウェートのロゴ","ワンピース","ナルト"],
    ko: ["어린이","클럽 엠블럼","쿠웨이트 로고","원피스","나루토"],
    th: ["เด็ก","โลโก้สโมสร","โลโก้คูเวต","วันพีซ","นารูโตะ"],
    vi: ["Thiếu nhi","Logo câu lạc bộ","Logo Kuwait","One Piece","Naruto"],
    tl: ["Mga bata","Mga logo ng club","Mga logo ng Kuwait","One Piece","Naruto"],
    sw: ["Watoto","Nembo za klabu","Nembo za Kuwait","One Piece","Naruto"],
    ha: ["Yara","Tambarin kulob","Tambarin Kuwait","One Piece","Naruto"],
    so: ["Carruurta","Astaamaha kooxaha","Astaamaha Kuwayt","One Piece","Naruto"],
    am: ["ልጆች","የክለብ አርማዎች","የኩዌት አርማዎች","ዋን ፒስ","ናሩቶ"]
  };
