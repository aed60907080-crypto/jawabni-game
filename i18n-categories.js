...
(function () {
  ...
  var P4 = {
    en: ["Kids","Club logos","Kuwaiti logos","One Piece"],
    fr: ["Enfants","Logos de clubs","Logos koweïtiens","One Piece"],
    es: ["Niños","Escudos de clubes","Logotipos kuwaitíes","One Piece"],
    pt: ["Crianças","Emblemas de clubes","Logótipos kuwaitianos","One Piece"],
    de: ["Kinder","Vereinswappen","Kuwaitische Logos","One Piece"],
    it: ["Bambini","Stemmi dei club","Loghi kuwaitiani","One Piece"],
    nl: ["Kinderen","Clublogo's","Koeweitse logo's","One Piece"],
    sv: ["Barn","Klubbmärken","Kuwaitiska logotyper","One Piece"],
    pl: ["Dzieci","Herby klubów","Kuwejckie logo","One Piece"],
    cs: ["Děti","Klubové znaky","Kuvajtská loga","One Piece"],
    ro: ["Copii","Embleme de cluburi","Logouri kuweitiene","One Piece"],
    hu: ["Gyerekek","Klubcímerek","Kuvaiti logók","One Piece"],
    el: ["Παιδιά","Σήματα ομάδων","Λογότυπα του Κουβέιτ","Ουάν Πις"],
    ru: ["Детям","Эмблемы клубов","Логотипы Кувейта","Ван-Пис"],
    uk: ["Дітям","Емблеми клубів","Логотипи Кувейту","Ван Піс"],
    tr: ["Çocuklar","Kulüp logoları","Kuveyt logoları","One Piece"],
    az: ["Uşaqlar","Klub loqoları","Küveyt loqoları","One Piece"],
    fa: ["کودکان","نشان باشگاه‌ها","لوگوهای کویتی","وان پیس"],
    ku: ["Zarok","Logoyên klûban","Logoyên Kuweytê","One Piece"],
    ur: ["بچے","کلبوں کے لوگو","کویتی لوگو","ون پیس"],
    ps: ["ماشومان","د کلبونو نښې","کویټي نښې","ون پیس"],
    he: ["ילדים","סמלי מועדונים","לוגואים כוויתיים","וואן פיס"],
    hi: ["बच्चे","क्लबों के लोगो","कुवैती लोगो","वन पीस"],
    bn: ["শিশু","ক্লাবের লোগো","কুয়েতি লোগো","ওয়ান পিস"],
    ta: ["குழந்தைகள்","கழக சின்னங்கள்","குவைத் சின்னங்கள்","ஒன் பீஸ்"],
    id: ["Anak-anak","Logo klub","Logo Kuwait","One Piece"],
    ms: ["Kanak-kanak","Logo kelab","Logo Kuwait","One Piece"],
    zh: ["儿童","俱乐部队徽","科威特标志","海贼王"],
    ja: ["キッズ","クラブのエンブレム","クウェートのロゴ","ワンピース"],
    ko: ["어린이","클럽 엠블럼","쿠웨이트 로고","원피스"],
    th: ["เด็ก","โลโก้สโมสร","โลโก้คูเวต","วันพีซ"],
    vi: ["Thiếu nhi","Logo câu lạc bộ","Logo Kuwait","One Piece"],
    tl: ["Mga bata","Mga logo ng club","Mga logo ng Kuwait","One Piece"],
    sw: ["Watoto","Nembo za klabu","Nembo za Kuwait","One Piece"],
    ha: ["Yara","Tambarin kulob","Tambarin Kuwait","One Piece"],
    so: ["Carruurta","Astaamaha kooxaha","Astaamaha Kuwayt","One Piece"],
    am: ["ልጆች","የክለብ አርማዎች","የኩዌት አርማዎች","ዋን ፒስ"]
  };
