...
(function () {
  ...
  var K2 = [
    ...
    /* 17 */ "اختر حتى ٦ فئات لتبدأ الجولة — كل فئة تحمل ٦ أسئلة بقيم مختلفة",
  ...
  P2.en = ["Your points","Your balance","Your browser does not support canvas.","Fastest answer…","Biggest balance",
    ...
    "Pick up to 6 categories to start the round — each holds 6 questions of different values",
  ...
  P2.fr = ["Vos points","Votre solde","Votre navigateur ne prend pas en charge canvas.","Réponse la plus rapide…","Plus gros solde",
    ...
    "Choisissez jusqu'à 6 catégories pour lancer la manche — chacune contient 6 questions de valeurs différentes",
  ...
  P2.es = ["Tus puntos","Tu saldo","Tu navegador no admite canvas.","La respuesta más rápida…","El mayor saldo",
    ...
    "Elige hasta 6 categorías para empezar la ronda — cada una trae 6 preguntas de distinto valor",
  ...
  P2.pt = ["Os seus pontos","O seu saldo","O seu navegador não suporta canvas.","A resposta mais rápida…","O maior saldo",
    ...
    "Escolha até 6 categorias para começar a rodada — cada uma traz 6 perguntas de valores diferentes",
  ...
  P2.de = ["Deine Punkte","Dein Guthaben","Dein Browser unterstützt canvas nicht.","Die schnellste Antwort…","Das größte Guthaben",
    ...
    "Wähle bis zu 6 Kategorien, um die Runde zu starten — jede enthält 6 Fragen mit verschiedenen Werten",
  ...
  P2.it = ["I tuoi punti","Il tuo credito","Il tuo browser non supporta canvas.","La risposta più veloce…","Il credito più grande",
    ...
    "Scegli fino a 6 categorie per iniziare il turno — ognuna contiene 6 domande di valore diverso",
  ...
  P2.nl = ["Jouw punten","Jouw saldo","Je browser ondersteunt canvas niet.","Het snelste antwoord…","Het grootste saldo",
    ...
    "Kies tot 6 categorieën om de ronde te starten — elke categorie heeft 6 vragen met verschillende waarden",
  ...
  P2.sv = ["Dina poäng","Ditt saldo","Din webbläsare stöder inte canvas.","Snabbaste svaret…","Största saldot",
    ...
    "Välj upp till 6 kategorier för att starta omgången — varje kategori har 6 frågor med olika värden",
  ...
  P2.pl = ["Twoje punkty","Twoje saldo","Twoja przeglądarka nie obsługuje canvas.","Najszybsza odpowiedź…","Największe saldo",
    ...
    "Wybierz do 6 kategorii, aby rozpocząć rundę — każda ma 6 pytań o różnej wartości",
  ...
  P2.cs = ["Tvoje body","Tvůj zůstatek","Tvůj prohlížeč nepodporuje canvas.","Nejrychlejší odpověď…","Největší zůstatek",
    ...
    "Vyber až 6 kategorií a spusť kolo — každá má 6 otázek s různou hodnotou",
  ...
  P2.ro = ["Punctele tale","Soldul tău","Browserul tău nu acceptă canvas.","Cel mai rapid răspuns…","Cel mai mare sold",
    ...
    "Alege până la 6 categorii ca să începi runda — fiecare are 6 întrebări cu valori diferite",
  ...
  P2.hu = ["A pontjaid","Az egyenleged","A böngésződ nem támogatja a canvast.","A leggyorsabb válasz…","A legnagyobb egyenleg",
    ...
    "Válassz legfeljebb 6 kategóriát a kör indításához — mindegyikben 6 különböző értékű kérdés van",
  ...
  P2.el = ["Οι πόντοι σου","Το υπόλοιπό σου","Ο περιηγητής σου δεν υποστηρίζει canvas.","Η πιο γρήγορη απάντηση…","Το μεγαλύτερο υπόλοιπο",
    ...
    "Διάλεξε έως 6 κατηγορίες για να ξεκινήσει ο γύρος — καθεμία έχει 6 ερωτήσεις διαφορετικής αξίας",
  ...
  P2.ru = ["Твои очки","Твой баланс","Твой браузер не поддерживает canvas.","Самый быстрый ответ…","Самый большой баланс",
    ...
    "Выбери до 6 категорий, чтобы начать раунд — в каждой 6 вопросов разной стоимости",
  ...
  P2.uk = ["Твої очки","Твій баланс","Твій браузер не підтримує canvas.","Найшвидша відповідь…","Найбільший баланс",
    ...
    "Обери до 6 категорій, щоб почати раунд — у кожній 6 питань різної вартості",
  ...
  P2.tr = ["Puanların","Bakiyen","Tarayıcın canvas desteklemiyor.","En hızlı cevap…","En büyük bakiye",
    ...
    "Turu başlatmak için en fazla 6 kategori seç — her biri farklı değerde 6 soru taşır",
  ...
  P2.az = ["Xalların","Balansın","Brauzerin canvas dəstəkləmir.","Ən sürətli cavab…","Ən böyük balans",
    ...
    "Raundu başlatmaq üçün 6-ya qədər kateqoriya seç — hər birində fərqli dəyərdə 6 sual var",
  ...
  P2.fa = ["امتیازهای تو","موجودی تو","مرورگر تو از canvas پشتیبانی نمی‌کند.","سریع‌ترین پاسخ…","بزرگ‌ترین موجودی",
    ...
    "تا ۶ دسته انتخاب کن تا دور آغاز شود — هر دسته ۶ پرسش با ارزش‌های متفاوت دارد",
  ...
  P2.ku = ["Xalên te","Balansa te","Geroka te canvas piştgirî nake.","Bersiva herî bilez…","Balansa herî mezin",
    ...
    "Heta 6 kategoriyan hilbijêre da ku ger dest pê bike — di her yekê de 6 pirsyarên bi nirxên cuda hene",
  ...
  P2.ur = ["آپ کے پوائنٹس","آپ کا بیلنس","آپ کا براؤزر canvas کی حمایت نہیں کرتا۔","تیز ترین جواب…","سب سے بڑا بیلنس",
    ...
    "راؤنڈ شروع کرنے کے لیے زیادہ سے زیادہ ۶ اقسام چنیں — ہر ایک میں مختلف قدر کے ۶ سوال ہیں",
  ...
  P2.ps = ["ستا ټکي","ستا بیلانس","ستا براوزر canvas نه ملاتړ کوي.","تر ټولو ګړندی ځواب…","تر ټولو لوی بیلانس",
    ...
    "د پړاو پیلولو لپاره تر ۶ پورې ډلې وټاکه — هره یوه شپږ پوښتنې په بېلابېلو ارزښتونو لري",
  ...
  P2.he = ["הנקודות שלך","היתרה שלך","הדפדפן שלך אינו תומך ב-canvas.","התשובה המהירה ביותר…","היתרה הגדולה ביותר",
    ...
    "בחר עד 6 קטגוריות כדי להתחיל את הסבב — בכל אחת 6 שאלות בערכים שונים",
  ...
  P2.hi = ["आपके अंक","आपका बैलेंस","आपका ब्राउज़र canvas का समर्थन नहीं करता।","सबसे तेज़ जवाब…","सबसे बड़ा बैलेंस",
    ...
    "राउंड शुरू करने के लिए 6 तक श्रेणियाँ चुनें — हर एक में अलग-अलग मूल्य के 6 प्रश्न हैं",
  ...
  P2.bn = ["আপনার পয়েন্ট","আপনার ব্যালেন্স","আপনার ব্রাউজার canvas সমর্থন করে না।","দ্রুততম উত্তর…","সবচেয়ে বড় ব্যালেন্স",
    ...
    "রাউন্ড শুরু করতে সর্বোচ্চ ৬টি বিভাগ বেছে নিন — প্রতিটিতে ভিন্ন মানের ৬টি প্রশ্ন আছে",
  ...
  P2.ta = ["உங்கள் புள்ளிகள்","உங்கள் இருப்பு","உங்கள் உலாவி canvas ஐ ஆதரிக்கவில்லை.","வேகமான பதில்…","மிகப்பெரிய இருப்பு",
    ...
    "சுற்றைத் தொடங்க 6 பிரிவுகள் வரை தேர்வு செய்யுங்கள் — ஒவ்வொன்றிலும் வெவ்வேறு மதிப்புள்ள 6 கேள்விகள்",
  ...
  P2.id = ["Poinmu","Saldomu","Peramban kamu tidak mendukung canvas.","Jawaban tercepat…","Saldo terbesar",
    ...
    "Pilih hingga 6 kategori untuk memulai ronde — masing-masing berisi 6 pertanyaan dengan nilai berbeda",
  ...
  P2.ms = ["Mata anda","Baki anda","Pelayar anda tidak menyokong canvas.","Jawapan terpantas…","Baki terbesar",
    ...
    "Pilih sehingga 6 kategori untuk memulakan pusingan — setiap satu mengandungi 6 soalan bernilai berbeza",
  ...
  P2.zh = ["你的积分","你的余额","你的浏览器不支持 canvas。","最快的回答…","最大的余额",
    ...
    "© 版权所有 — 准备好，作答，获胜",
    "最多选择 6 个类别开始本轮 — 每个类别有 6 道不同分值的题目",
  ...
  P2.ja = ["あなたのポイント","あなたの残高","お使いのブラウザーは canvas に対応していません。","いちばん速い回答…","いちばん多い残高",
    ...
    "ラウンドを始めるにはカテゴリーを6つまで選択 — 各カテゴリーに配点の異なる6問",
  ...
  P2.ko = ["내 점수","내 잔액","브라우저가 canvas를 지원하지 않습니다.","가장 빠른 정답…","가장 많은 잔액",
    ...
    "라운드를 시작하려면 카테고리를 최대 6개 선택 — 각 카테고리에 점수가 다른 6문항",
  ...
  P2.th = ["คะแนนของคุณ","ยอดคงเหลือของคุณ","เบราว์เซอร์ของคุณไม่รองรับ canvas","คำตอบที่เร็วที่สุด…","ยอดคงเหลือที่มากที่สุด",
    ...
    "เลือกได้สูงสุด 6 หมวดหมู่เพื่อเริ่มรอบ — แต่ละหมวดมี 6 คำถามคะแนนต่างกัน",
  ...
  P2.vi = ["Điểm của bạn","Số dư của bạn","Trình duyệt của bạn không hỗ trợ canvas.","Câu trả lời nhanh nhất…","Số dư lớn nhất",
    ...
    "Chọn tối đa 6 danh mục để bắt đầu vòng chơi — mỗi danh mục có 6 câu hỏi giá trị khác nhau",
  ...
  P2.tl = ["Ang iyong puntos","Ang iyong balanse","Hindi sinusuportahan ng browser mo ang canvas.","Ang pinakamabilis na sagot…","Ang pinakamalaking balanse",
    ...
    "Pumili ng hanggang 6 na kategorya para simulan ang round — bawat isa ay may 6 tanong na magkakaibang halaga",
  ...
  P2.sw = ["Pointi zako","Salio lako","Kivinjari chako hakiungi mkono canvas.","Jibu la haraka zaidi…","Salio kubwa zaidi",
    ...
    "Chagua hadi kategoria 6 kuanza raundi — kila moja ina maswali 6 ya thamani tofauti",
  ...
  P2.ha = ["Makin ka","Ma'aunin ka","Burauzarka ba ya goyon bayan canvas.","Amsa mafi sauri…","Ma'auni mafi girma",
    ...
    "Zaɓi har rukunoni 6 don fara zagaye — kowanne yana da tambayoyi 6 na daban-daban darajoji",
  ...
  P2.so = ["Dhibcahaaga","Haraagaaga","Biraawsarkaagu ma taageero canvas.","Jawaabta ugu dhaqsaha badan…","Haraaga ugu weyn",
    ...
    "Dooro ilaa 6 qaybood si aad u bilowdo wareegga — mid kastaa wuxuu leeyahay 6 su'aalood oo qiimo kala duwan leh",
  ...
  P2.am = ["ነጥቦችህ","ቀሪ ሂሳብህ","አሳሽህ canvas አይደግፍም።","በጣም ፈጣኑ መልስ…","ትልቁ ቀሪ ሂሳብ",
    ...
    "ዙሩን ለመጀመር እስከ 6 ምድቦች ምረጥ — እያንዳንዱ የተለያየ ዋጋ ያላቸው 6 ጥያቄዎች አሉት",
  ...
  var K5 = ["إسلاميات", "العالم", "طبيعة وحياة", "ثقافة وفنون", "ترفيه", "الخليج", "الكويت", "تاريخ وحضارات", "لغة وأدب", "أنمي وكرتون"];
  var P5 = {
    en: ["Islamic","World","Nature & Life","Culture & Arts","Entertainment","The Gulf","Kuwait","History & Civilizations","Language & Literature","Anime & Cartoons"],
    fr: ["Islam","Monde","Nature et vie","Culture et arts","Divertissement","Le Golfe","Koweït","Histoire et civilisations","Langue et littérature","Anime et dessins animés"],
    es: ["Islam","Mundo","Naturaleza y vida","Cultura y artes","Entretenimiento","El Golfo","Kuwait","Historia y civilizaciones","Lengua y literatura","Anime y dibujos animados"],
    pt: ["Islão","Mundo","Natureza e vida","Cultura e artes","Entretenimento","O Golfo","Kuwait","História e civilizações","Língua e literatura","Anime e desenhos animados"],
    de: ["Islam","Welt","Natur & Leben","Kultur & Kunst","Unterhaltung","Der Golf","Kuwait","Geschichte & Zivilisationen","Sprache & Literatur","Anime & Zeichentrick"],
    it: ["Islam","Mondo","Natura e vita","Cultura e arti","Intrattenimento","Il Golfo","Kuwait","Storia e civiltà","Lingua e letteratura","Anime e cartoni"],
    nl: ["Islam","Wereld","Natuur & leven","Cultuur & kunst","Entertainment","De Golf","Koeweit","Geschiedenis & beschavingen","Taal & literatuur","Anime & tekenfilms"],
    sv: ["Islam","Världen","Natur & liv","Kultur & konst","Underhållning","Gulfen","Kuwait","Historia & civilisationer","Språk & litteratur","Anime & tecknat"],
    pl: ["Islam","Świat","Natura i życie","Kultura i sztuka","Rozrywka","Zatoka","Kuwejt","Historia i cywilizacje","Język i literatura","Anime i kreskówki"],
    cs: ["Islám","Svět","Příroda a život","Kultura a umění","Zábava","Záliv","Kuvajt","Dějiny a civilizace","Jazyk a literatura","Anime a kreslené filmy"],
    ro: ["Islam","Lumea","Natură și viață","Cultură și arte","Divertisment","Golful","Kuwait","Istorie și civilizații","Limbă și literatură","Anime și desene animate"],
    hu: ["Iszlám","Világ","Természet és élet","Kultúra és művészet","Szórakozás","Az Öböl","Kuvait","Történelem és civilizációk","Nyelv és irodalom","Anime és rajzfilmek"],
    el: ["Ισλάμ","Κόσμος","Φύση & ζωή","Πολιτισμός & τέχνες","Ψυχαγωγία","Ο Κόλπος","Κουβέιτ","Ιστορία & πολιτισμοί","Γλώσσα & λογοτεχνία","Anime & κινούμενα σχέδια"],
    ru: ["Ислам","Мир","Природа и жизнь","Культура и искусство","Развлечения","Залив","Кувейт","История и цивилизации","Язык и литература","Аниме и мультфильмы"],
    uk: ["Іслам","Світ","Природа й життя","Культура й мистецтво","Розваги","Затока","Кувейт","Історія та цивілізації","Мова й література","Аніме та мультфільми"],
    tr: ["İslam","Dünya","Doğa ve yaşam","Kültür ve sanat","Eğlence","Körfez","Kuveyt","Tarih ve medeniyetler","Dil ve edebiyat","Anime ve çizgi film"],
    az: ["İslam","Dünya","Təbiət və həyat","Mədəniyyət və incəsənət","Əyləncə","Körfəz","Küveyt","Tarix və sivilizasiyalar","Dil və ədəbiyyat","Anime və cizgi filmləri"],
    fa: ["اسلامی","جهان","طبیعت و زندگی","فرهنگ و هنر","سرگرمی","خلیج","کویت","تاریخ و تمدن‌ها","زبان و ادبیات","انیمه و کارتون"],
    ku: ["Îslamî","Cîhan","Xweza û jiyan","Çand û huner","Şahî","Kendav","Kuweyt","Dîrok û şaristanî","Ziman û wêje","Anime û kartûn"],
    ur: ["اسلامی","دنیا","فطرت اور زندگی","ثقافت و فنون","تفریح","خلیج","کویت","تاریخ و تہذیبیں","زبان و ادب","اینیمے اور کارٹون"],
    ps: ["اسلامي","نړۍ","طبیعت او ژوند","کلتور او هنر","تفریح","خلیج","کویت","تاریخ او تمدنونه","ژبه او ادب","انیمه او کارټون"],
    he: ["איסלאם","העולם","טבע וחיים","תרבות ואמנות","בידור","המפרץ","כווית","היסטוריה ותרבויות","שפה וספרות","אנימה וסרטים מצוירים"],
    hi: ["इस्लामी","दुनिया","प्रकृति और जीवन","संस्कृति और कला","मनोरंजन","खाड़ी","कुवैत","इतिहास और सभ्यताएँ","भाषा और साहित्य","एनीमे और कार्टून"],
    bn: ["ইসলামিক","বিশ্ব","প্রকৃতি ও জীবন","সংস্কৃতি ও শিল্প","বিনোদন","উপসাগর","কুয়েত","ইতিহাস ও সভ্যতা","ভাষা ও সাহিত্য","অ্যানিমে ও কার্টুন"],
    ta: ["இஸ்லாமிய","உலகம்","இயற்கை & வாழ்க்கை","கலை & பண்பாடு","பொழுதுபோக்கு","வளைகுடா","குவைத்","வரலாறு & நாகரிகங்கள்","மொழி & இலக்கியம்","அனிமே & கார்ட்டூன்"],
    id: ["Islami","Dunia","Alam & kehidupan","Budaya & seni","Hiburan","Teluk","Kuwait","Sejarah & peradaban","Bahasa & sastra","Anime & kartun"],
    ms: ["Islami","Dunia","Alam & kehidupan","Budaya & seni","Hiburan","Teluk","Kuwait","Sejarah & tamadun","Bahasa & sastera","Anime & kartun"],
    zh: ["伊斯兰","世界","自然与生活","文化与艺术","娱乐","海湾","科威特","历史与文明","语言与文学","动漫与卡通"],
    ja: ["イスラム","世界","自然と生命","文化と芸術","エンタメ","湾岸","クウェート","歴史と文明","言語と文学","アニメ・カートゥーン"],
    ko: ["이슬람","세계","자연과 생명","문화와 예술","엔터테인먼트","걸프","쿠웨이트","역사와 문명","언어와 문학","애니메이션과 만화"],
    th: ["อิสลาม","โลก","ธรรมชาติและชีวิต","วัฒนธรรมและศิลปะ","บันเทิง","อ่าวอาหรับ","คูเวต","ประวัติศาสตร์และอารยธรรม","ภาษาและวรรณกรรม","อนิเมะและการ์ตูน"],
    vi: ["Hồi giáo","Thế giới","Thiên nhiên & đời sống","Văn hóa & nghệ thuật","Giải trí","Vùng Vịnh","Kuwait","Lịch sử & nền văn minh","Ngôn ngữ & văn học","Anime & hoạt hình"],
    tl: ["Islamiko","Mundo","Kalikasan at buhay","Kultura at sining","Aliwan","Ang Golpo","Kuwait","Kasaysayan at kabihasnan","Wika at panitikan","Anime at cartoon"],
    sw: ["Kiislamu","Dunia","Asili na maisha","Utamaduni na sanaa","Burudani","Ghuba","Kuwait","Historia na ustaarabu","Lugha na fasihi","Anime na katuni"],
    ha: ["Musulunci","Duniya","Yanayi da rayuwa","Al'ada da fasaha","Nishaɗi","Tekun Gulf","Kuwait","Tarihi da wayewa","Harshe da adabi","Anime da zane-zane"],
    so: ["Islaami","Adduunka","Dabeecadda iyo nolosha","Dhaqanka iyo farshaxanka","Madadaalo","Gacanka","Kuwayt","Taariikhda iyo ilbaxnimada","Luqadda iyo suugaanta","Anime iyo kartoon"],
    am: ["እስላማዊ","ዓለም","ተፈጥሮ እና ሕይወት","ባህልና ጥበብ","መዝናኛ","ባሕረ ሰላጤ","ኩዌት","ታሪክና ሥልጣኔዎች","ቋንቋና ሥነ ጽሑፍ","አኒሜና ካርቱን"]
  };
