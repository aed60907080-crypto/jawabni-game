...
(function (global) {
  ...
  var INFO = {
    ...
    "خرائط": "خريطة العالم وعليها حلقة على دولة — ما اسمها؟",
    ...
    "رياضة": "أسئلة رياضية عامة: كرة القدم والسلة والتنس والأبطال.",
    "تخمين اللاعب": "أوصاف لاعب كرة القدم ومسيرته — من هو؟",
    "من صاحب الهدف": "شاهد مقطع هدف مشهور — من سجّله؟",
    "سيارات": "شعارات وموديلات وشركات السيارات ومعلوماتها.",
    "تقنية": "الشركات والأجهزة والإنترنت والتطبيقات.",
    "ألعاب فيديو": "شخصيات الألعاب وشركاتها وأشهر إصداراتها.",
    "أفلام وأنمي": "أفلام عالمية وشخصيات أنمي مشهورة.",
    "البوكيمون": "أسماء البوكيمون وأنواعها وشخصيات الأنمي.",
    "ارطغرل": "أحداث وشخصيات مسلسل «قيامة أرطغرل».",
    "المؤسس عثمان": "أحداث وشخصيات مسلسل «المؤسس عثمان».",
    "الحفره": "أحداث وشخصيات المسلسل التركي «الحفرة».",
    "خمن اسم المسلسل": "وصف مسلسل خليجي أو عربي مع صورته — ما اسمه؟",
    ...
    "كرة القدم العالمية": "الأندية والدوريات والنجوم والأرقام القياسية.",
    "كأس العالم": "بطولات كأس العالم وأبطالها وهدّافوها.",
    "الألعاب الأولمبية": "الدورات الأولمبية ورياضاتها وأبطالها.",
    ...
    "دراغون بول": "شخصيات «دراغون بول» وقتالاتها وتحوّلاتها.",
    "المحقق كونان": "شخصيات وقضايا «المحقق كونان».",
    "سترينجر ثينجز": "شخصيات وأحداث مسلسل «سترينجر ثينجز».",
    "لورد أوف ذا رينغز": "شخصيات وأماكن «سيد الخواتم».",
    ...
    "شعارات أندية": "شعار نادٍ بلا كتابة — ما اسم النادي؟",
  ...
  function infoFor(name) {
    ...
    list.forEach(function (q) {
      ...
      else if (q.yt || q.video) media.video++;
