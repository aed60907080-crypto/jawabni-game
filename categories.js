...
(function (global) {
  ...
  var CATEGORIES = [
    ...
    /* ===== الدفعة الخامسة ===== */
    /* الصورة غلاف الأنمي من AniList (مصدر صور شخصياته نفسه) */
    { name: "ون بيس",                  img: "https://s4.anilist.co/file/anilistcdn/media/anime/cover/large/bx21-ELSYx3yMPcKM.jpg", emoji: "🏴‍☠️", tint: "#b8322a", group: "media" }
  ];
