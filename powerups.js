/* ============================================================
   ...
   ٢) المساعدات (Lifelines) — للفريق صاحب الدور
      ...
      المزيد بنقاط حسابه من متجر المساعدات في صفحة الرصيد، وما يشتريه
...
(function (global) {
  ...
  /* قيم النقاط الخمس على كل بطاقة فئة */
  var POINT_VALUES = [100, 200, 300, 400, 500];

  /* كم مفاجأة تُوزَّع على اللوحة (من أصل 30 بطاقة) */
