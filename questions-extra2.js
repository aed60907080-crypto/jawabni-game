...
(function () {
  ...
  /* ---------- من صاحب الهدف (14 سؤالاً) ----------
     «من صاحب هذا الهدف؟» — مقطع قصير (6–26 ثانية) لهدف مشهور، يُعرض
     بالأبيض والأسود (bw: true) حتى لا تكشف ألوان القميص الفريق واللاعب.
  ...
  extra["من صاحب الهدف"] = [
    ...
    { l: 1, q: "من صاحب هذا الهدف؟", a: "زين الدين زيدان — مقصّيته في نهائي دوري الأبطال 2002",
      yt: "VpICpnKD76k", hide: GOAL_MASK, bw: true },
    { l: 1, q: "من صاحب هذا الهدف؟", a: "واين روني — المقصية في ديربي مانشستر 2011",
      yt: "v7E1WJVMhzA", hide: GOAL_MASK, bw: true },

    /* ===== المستوى الثاني ===== */
    { l: 2, q: "من صاحب هذا الهدف؟", a: "تييري هنري — هدفه في مرمى مانشستر يونايتد",
      yt: "AUTyZVsLxYE", hide: GOAL_MASK, bw: true },
    { l: 2, q: "من صاحب هذا الهدف؟", a: "ستيفن جيرارد — تسديدته من ثلاثين ياردة",
      yt: "uYdEwsXxBJ4", hide: GOAL_MASK, bw: true },
    { l: 2, q: "من صاحب هذا الهدف؟", a: "سيرخيو أغويرو — هدف اللقب في الدقيقة 93:20",
      yt: "360iTp5EhnA", hide: GOAL_MASK, bw: true },

    /* ===== المستوى الثالث ===== */
    { l: 3, q: "من صاحب هذا الهدف؟", a: "سون هيونغ مين — انطلاقته وهدفه في مرمى بيرنلي",
      yt: "M4fXfc-4Rb8", hide: GOAL_MASK, bw: true },
    { l: 3, q: "من صاحب هذا الهدف؟", a: "إيدين هازارد — هدفه الفردي في الدوري الإنجليزي",
      yt: "mCkgLm5IkmM", hide: GOAL_MASK, bw: true },
    { l: 3, q: "من صاحب هذا الهدف؟", a: "واين روني — مقصّيته الطائرة في مرمى نيوكاسل",
      yt: "GNMki7g61Yk", hide: GOAL_MASK, bw: true },

    /* ===== المستوى الرابع ===== */
    { l: 4, q: "من صاحب هذا الهدف؟", a: "لويس سواريز — لمسته وتسديدته في الدوري الإنجليزي",
      yt: "Oog2lNMIy5Q", hide: GOAL_MASK, bw: true },
    { l: 4, q: "من صاحب هذا الهدف؟", a: "كيفن دي بروين — صاروخيته في مرمى نيوكاسل",
      yt: "mnVSEcWIxTo", hide: GOAL_MASK, bw: true },
    { l: 4, q: "من صاحب هذا الهدف؟", a: "محمد صلاح — انطلاقته الفردية في مرمى مانشستر سيتي",
      yt: "JDAllFTiiy8", hide: GOAL_MASK, bw: true },

    /* ===== المستوى الخامس ===== */
    { l: 5, q: "من صاحب هذا الهدف؟", a: "ساديو ماني — هدف رائع مع ليفربول",
      yt: "ntV34y9HVUw", hide: GOAL_MASK, bw: true },
    { l: 5, q: "من صاحب هذا الهدف؟", a: "بوكايو ساكا — هدفه بعد انطلاقة تيمبر مع آرسنال",
      yt: "7XV6spe_veU", hide: GOAL_MASK, bw: true },
  ];
